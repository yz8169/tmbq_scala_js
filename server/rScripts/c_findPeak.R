  ...
  for (bat in uniqBatch) {
    ...
    for (fileName in fileNames) {
      ...
      plot(data$SEC, originalData, col = "red", cex = 0.5,
           main = paste("raw chromatogram | batch: ", bat, "    sample: ", fileName, "    conc: ", mic,
                        "    function: ", compoundRow$fc, "    mass: ", compoundRow$mz,
                        sep = ""),
      ...
      plot2 = plot(data$SEC, correctValue, col = "red", cex = 0.5, xlab = "RT(m)",
                   main = paste("peak picking | window size: ", compoundRow$fl, "   iteration: ", compoundRow$iteration, "    lp: ", compoundRow$nups,
                                "    rp: ", compoundRow$ndowns, "    snr: ", compoundRow$snr, "    peak location: ",
